...
wget -O /usr/bin/renew-pptp https://raw.githubusercontent.com/adamtech323/VPS-SC/main/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -O /usr/bin/renew-l2tp https://raw.githubusercontent.com/adamtech323/VPS-SC/main/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
wget -O /usr/bin/cek-pptp https://raw.githubusercontent.com/adamtech323/VPS-SC/main/cek-pptp.sh && chmod +x /usr/bin/cek-pptp
